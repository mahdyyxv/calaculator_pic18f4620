...
# 31 "ECU_Layer/Lcd/../../Mcal_Layer/GPIO/hal_gpio.h"
typedef enum
{
    GPIO_LOW = 0,
    GPIO_HIGH
...
# 29 "ECU_Layer/Lcd/ecu_lcd.c"
Std_ReturnType lcd_4bit_initialize(const lcd_4bit_t * _lcd_config)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_data_pins_cnt = 0;
    if(((void*)0) == _lcd_config)
    {
    ...
    else
    {
            ...
            (gpio_pin_direction_init(&(_lcd_config -> lcd_en))) )
        {
            ...
            ret &= lcd_4bit_send_command(_lcd_config , 0x38);
            ...
            ret &= lcd_4bit_send_command(_lcd_config , 0x01);
            ret &= lcd_4bit_send_command(_lcd_config , 0x02);
            ret &= lcd_4bit_send_command(_lcd_config , 0x06);
            ret &= lcd_4bit_send_command(_lcd_config , 0x0C);
            ret &= lcd_4bit_send_command(_lcd_config , 0x80);
            ret &= lcd_4bit_send_command(_lcd_config , 0x28);
        }
        else
        {
            ret = (Std_ReturnType)0x00;
...
# 197 "ECU_Layer/Lcd/ecu_lcd.c"
Std_ReturnType lcd_4bit_send_string_pos(const lcd_4bit_t * _lcd_config, uint8 row, uint8 col, uint8 *str)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _lcd_config || ((void*)0) == str)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
Std_ReturnType lcd_4bit_send_custom_char(const lcd_4bit_t * _lcd_config, uint8 row, uint8 col, uint8 _chr[], uint8 mempos)
{
    ...
    {
        lcd_4bit_send_command(_lcd_config, (0x40 + (mempos * 8)));
...
Std_ReturnType lcd_8bit_initialize(const lcd_8bit_t * _lcd_config)
{
    ...
    else
    {
            ...
            (gpio_pin_direction_init(&(_lcd_config -> lcd_en))) )
        {
            ...
            _delay((unsigned long)((20)*(4000000UL/4000.0)));
            ret &= lcd_8bit_send_command(_lcd_config , 0x38);
            _delay((unsigned long)((5)*(4000000UL/4000.0)));
            ret &= lcd_8bit_send_command(_lcd_config , 0x38);
            _delay((unsigned long)((150)*(4000000UL/4000000.0)));
            ret &= lcd_8bit_send_command(_lcd_config , 0x38);

            ret &= lcd_8bit_send_command(_lcd_config , 0x01);
            ret &= lcd_8bit_send_command(_lcd_config , 0x02);
            ret &= lcd_8bit_send_command(_lcd_config , 0x06);
            ret &= lcd_8bit_send_command(_lcd_config , 0x0C);
            ret &= lcd_8bit_send_command(_lcd_config , 0x80);
        }
        else
        {
            ret = (Std_ReturnType)0x00;
...
Std_ReturnType lcd_8bit_send_custom_char(const lcd_8bit_t * _lcd_config, uint8 row, uint8 col, uint8 _chr[], uint8 mempos)
{
    ...
    {
        lcd_8bit_send_command(_lcd_config, (0x40 + (mempos * 8)));
        for(l_cnt = 0 ; l_cnt < 8 ; l_cnt++)
        {
...
static Std_ReturnType lcd_4bit_set_cursor(const lcd_4bit_t * _lcd_config, uint8 row, uint8 column)
{
    ...
    switch(row)
    {
        case 1 : ret &= lcd_4bit_send_command(_lcd_config , (0x80 + column)); break;
        case 2 : ret &= lcd_4bit_send_command(_lcd_config , (0xC0 + column)); break;
        case 3 : ret &= lcd_4bit_send_command(_lcd_config , (0x94 + column)); break;
        case 4 : ret &= lcd_4bit_send_command(_lcd_config , (0xD4 + column)); break;
...
static Std_ReturnType lcd_8bit_set_cursor(const lcd_8bit_t * _lcd_config, uint8 row, uint8 column)
{
    ...
    switch(row)
    {
        case 1 : ret &= lcd_8bit_send_command(_lcd_config , (0x80 + column)); break;
        case 2 : ret &= lcd_8bit_send_command(_lcd_config , (0xC0 + column)); break;
        case 3 : ret &= lcd_8bit_send_command(_lcd_config , (0x94 + column)); break;
        case 4 : ret &= lcd_8bit_send_command(_lcd_config , (0xD4 + column)); break;
        default : ret = (Std_ReturnType)0x00; break;
    }
    return ret;
}
